...
const dict = {
	...
	'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.':
		{
			fr: "Créez votre propre collection d'arrière-plans sur Unsplash et insérez ici l'ID présent dans l'URL. Vous pouvez insérer plusieurs collections en séparant leur ID par une virgule.",
			sv: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			nl: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			pl: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			pt_BR: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			ru: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			zh_CN: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			sk: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			de: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			it: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			es: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
			no: 'Create your own background collections on Unsplash and paste in the ID from their URL. You can set multiple collections by separating them with a comma.',
		},
	Name: {
		fr: 'Nom',
		sv: 'Namn',
