...
const dict = {
	...
	"These are Bonjourr's bookmarks. Edit your Quick Links by right clicking on their icon.": {
		...
		pt_BR: "These are Bonjourr's bookmarks. Edit your Quick Links by right clicking on their icon.",
	...
	'Type the collection id from its URL. Add more by separating them with a comma.': {
		...
		pt_BR: 'Type the collection id from its URL. Add more by separating them with a comma.',
