...
export const dict = {
	...
	'Choose a layout, click edit and select a widget to modify.': {
		...
		zh_HK: '選擇一個佈局, 單擊編輯並選中一個小部件來進行修改.',
	...
	'Detailed weather': {
		...
		sk: 'Podrobné počasie',
		sv: 'Detaljerat väder',
		pl: 'Szczegółowa pogoda',
		pt_BR: 'Tempo detalhado',
		nl: 'Gedetailleerd weer',
		ru: 'Подробная погода',
		zh_CN: '详细天气',
		zh_HK: '詳細天氣',
		de: 'Detailliertes Wetter',
		it: 'Meteo dettagliato',
		es: 'Tiempo detallado',
		tr: 'Detaylı hava durumu',
		uk: 'Детальна погода',
		id: 'Cuaca terperinci',
		da: 'Detaljeret vejr',
		fi: 'Yksityiskohtainen sää',
	...
	'Custom provider': {
		...
		sk: 'Vlastný poskytovateľ',
		sv: 'Anpassad leverantör',
		pl: 'Dostawca niestandardowy',
		pt_BR: 'Fornecedor personalizado',
		nl: 'Aangepaste provider',
		ru: 'Пользовательский провайдер',
		zh_CN: '自定义提供者',
		zh_HK: '自定義提供者',
		de: 'Benutzerdefinierter Anbieter',
		it: 'Provider personalizzato',
		es: 'Proveedor personalizado',
		tr: 'Özel sağlayıcı',
		uk: 'Користувацький провайдер',
		id: 'Penyedia khusus',
		da: 'Brugerdefineret udbyder',
		fi: 'Mukautettu palveluntarjoaja',
	...
	'Provider URL': {
		...
		sk: 'Adresa URL poskytovateľa',
		sv: 'Leverantörens URL',
		pl: 'Adres URL dostawcy',
		pt_BR: 'URL do fornecedor',
		nl: 'Provider URL',
		ru: 'URL провайдера',
		zh_CN: '提供者URL',
		zh_HK: '提供者 URL',
		de: 'Anbieter-URL',
		it: 'URL del provider',
		es: 'URL del proveedor',
		tr: "Sağlayıcı URL'si",
		uk: 'URL провайдера',
		id: 'URL Penyedia',
		da: 'URL for udbyder',
		fi: 'Palveluntarjoajan URL-osoite',
		hu: 'Szolgáltató URL',
		sr: 'УРЛ провајдера',
	...
	'You can now move widgets around, show your own quotes and much more. Take a look at the new features in ': {
		...
		zh_HK: '您現在可以向周圍移動小部件, 顯示您自己的引言等等. 從中看看新功能',
