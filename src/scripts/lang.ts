...
export const enginesLocales = {
	...
	'Bonjourr has been updated to version 1.16 ✨ ': {
		...
		sr: 'Bonjourr je ažuriran na verziju 1.16 ✨ ',
		sr_YU: 'Боњоурр је ажуриран у верзију 1.16 ✨ ',
	},
	'You can now move widgets around, show your own quotes and much more. Take a look at the new features in ': {
		fr: 'Vous pouvez maintenant réorganiser vos widgets, intégrer vos propres citations et plus encore. Jetez un oeil aux nouvelles fonctions dans ',
		...
		sr: 'Sada možete da pomerate vidžete, pokazujete sopstvene citate i još mnogo toga. Pogledajte nove funkcije u ',
		sr_YU: 'Сада можете да померате виџете около, приказујете сопствене цитате и још много тога. Погледајте нове функције у програму ',
	},
	'our full changelog ': {
		...
		sr: 'kompletna promena ',
		sr_YU: 'комплетна промена ',
	},
}
