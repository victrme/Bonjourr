...
export const dict = {
	...
	'Focus anywhere to edit Notes': {
		fr: "Cliquez n'importe où pour modifier les notes",
		sk: 'Zamerajte sa kdekoľvek na úpravu poznámok',
		sv: 'Fokusera någonstans för att redigera anteckningar',
		pl: 'Fokus w dowolnym miejscu, aby edytować notatki',
		pt_BR: 'Foco em qualquer lugar para editar notas',
		nl: 'Focus overal om notities te bewerken',
		ru: 'Фокус в любом месте для редактирования заметок',
		zh_CN: '聚焦任意位置编辑笔记',
		zh_HK: '聚焦任意位置編輯筆記',
		de: 'Konzentrieren Sie sich überall, um Notizen zu bearbeiten',
		it: 'Focalizza ovunque per modificare le note',
		es: 'Enfóquese en cualquier lugar para editar notas',
		tr: 'Notları düzenlemek için herhangi bir yere odaklanın',
		uk: 'Фокус будь-де, щоб редагувати Нотатки',
		id: 'Fokus di mana saja untuk mengedit Catatan',
	...
	'Supports markdown titles': {
		...
		sk: 'Podporuje názvy markdown',
		sv: 'Stödjer markdown-titlar',
		pl: 'Obsługuje tytuły markdown',
		pt_BR: 'Suporta títulos de remarcação',
		nl: 'Ondersteunt markdown-titels',
		ru: 'Поддерживает заголовки уценки',
		zh_CN: '支持 markdown 标题',
		zh_HK: '支持 markdown 標題',
		de: 'Unterstützt Markdown-Titel',
		it: 'Supporta i titoli markdown',
		es: 'Admite títulos de rebajas',
		tr: 'İşaretleme başlıklarını destekler',
		uk: 'Підтримує заголовки розмітки',
		id: 'Mendukung judul penurunan harga',
	...
	'Lists and clickable checkboxes': {
		...
		sk: 'Zoznamy a klikateľné zaškrtávacie políčka',
		sv: 'Listor och klickbara kryssrutor',
		pl: 'Listy i klikalne pola wyboru',
		pt_BR: 'Listas e caixas de seleção clicáveis',
		nl: 'Lijsten en aanklikbare selectievakjes',
		ru: 'Списки и интерактивные флажки',
		zh_CN: '列表和可点击的复选框',
		zh_HK: '列表和可點擊的複選框',
		de: 'Listen und anklickbare Kontrollkästchen',
		it: 'Elenchi e caselle di controllo selezionabili',
		es: 'Listas y casillas de verificación en las que se puede hacer clic',
		tr: 'Listeler ve tıklanabilir onay kutuları',
		uk: 'Списки та прапорці, які можна натиснути',
		id: 'Daftar dan kotak centang yang dapat diklik',
