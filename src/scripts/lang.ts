...
export const dict = {
	...
	'Click on "Editor" button below to edit': {
		fr: 'Cliquez sur le bouton "Editeur" ci-dessous pour modifier',
		sv: 'Klicka på knappen "Editor" nedan för att redigera',
		nl: 'Klik op de knop "Editor" hieronder om te bewerken',
		pl: 'Kliknij na przycisk "Edytor" poniżej, aby edytować',
		pt_BR: 'Clique no botão "Editor" abaixo para editar',
		ru: 'Нажмите на кнопку "Редактор" ниже для редактирования',
		zh_CN: '点击下面的 "编辑 "按钮进行编辑',
		zh_HK: 'Click on "Editor" below to edit!',
		sk: 'Kliknutím na tlačidlo "Editor" nižšie upravíte',
		de: 'Klicken Sie zum Bearbeiten auf die Schaltfläche "Editor" unten',
		it: 'Fare clic sul pulsante "Editor" qui sotto per modificare',
		es: 'Haga clic en el botón "Editor" para editar',
		tr: 'Düzenlemek için aşağıdaki "Editör" düğmesine tıklayın',
		uk: 'Натисніть на кнопку "Редактор" нижче для редагування',
		id: 'Klik tombol "Editor" di bawah untuk mengedit',
		da: 'Klik på "Editor"-knappen nedenfor for at redigere',
		fi: 'Klikkaa alla olevaa "Editor"-painiketta muokataksesi',
		hu: 'Kattintson az alábbi "Szerkesztő" gombra a szerkesztéshez',
	},
	'Supports **Markdown** and clickable checkboxes': {
		...
		id: 'Mendukung **Markdown** dan kotak centang yang dapat diklik',
	...
	'Buttons below automatically hide once this note has been modified. Hover with your mouse to show again.': {
		fr: 'Les boutons ci-dessous disparaissent automatiquement lorsque cette note a été modifiée. Survolez-les avec votre souris pour les afficher à nouveau.',
		sv: 'Knapparna nedan döljs automatiskt när anteckningen har ändrats. För att visa dem igen, rör dig med musen över dem.',
		nl: 'Onderstaande knoppen worden automatisch verborgen zodra deze notitie is gewijzigd. Beweeg met uw muis om ze weer te tonen.',
		pl: 'Przyciski poniżej automatycznie ukrywają się po zmodyfikowaniu tej notatki. Najedź myszką, aby pokazać je ponownie.',
		pt_BR: 'Os botões abaixo se escondem automaticamente uma vez que esta nota tenha sido modificada. Passe com o mouse para mostrar novamente.',
		ru: 'Кнопки ниже автоматически скрываются после изменения этой заметки. Наведите курсор мыши, чтобы они снова появились.',
		zh_CN: '一旦这个笔记被修改，下面的按钮会自动隐藏。用你的鼠标悬停，可以再次显示。',
		zh_HK: '見文檔',
		sk: 'Tlačidlá nižšie sa automaticky skryjú po úprave tejto poznámky. Ak ich chcete opäť zobraziť, prejdite na ne myšou.',
		de: 'Die Schaltflächen unten werden automatisch ausgeblendet, sobald diese Notiz geändert wurde. Fahren Sie mit der Maus darüber, um sie wieder einzublenden.',
		it: 'I pulsanti sottostanti si nascondono automaticamente una volta che la nota è stata modificata. Passare il mouse su di essi per visualizzarli nuovamente.',
		es: 'Los botones de abajo se ocultan automáticamente una vez modificada esta nota. Pase el ratón por encima para volver a mostrarlos.',
		tr: 'Bu not değiştirildiğinde aşağıdaki düğmeler otomatik olarak gizlenir. Tekrar göstermek için farenizle üzerine gelin.',
		uk: 'Кнопки нижче автоматично ховаються після того, як ця примітка була змінена. Наведіть курсор миші, щоб відобразити їх знову.',
		id: 'Tombol-tombol di bawah ini secara otomatis tersembunyi setelah catatan ini dimodifikasi. Arahkan kursor dengan mouse Anda untuk menampilkannya lagi.',
		da: 'Knapperne nedenfor skjules automatisk, når denne note er blevet ændret. Bevæg musen hen over dem for at vise dem igen.',
		fi: 'Alla olevat painikkeet piilotetaan automaattisesti, kun tätä huomautusta on muutettu. Näytä ne uudelleen hiirelläsi.',
		hu: 'Az alábbi gombok automatikusan elrejtődnek, ha a jegyzetet módosították. Az egérrel történő mozgatással újra megjelenítheti.',
	},
	'Text alignment': {
